...
from server.model.vendor import VendorModel

EndpointDataReader = AppDataReader()
db = VendorModel()

class VendorDataREST(object):
    pass
...
endpoint_data_list = EndpointDataReader.getEndpointData('vendor.json', '::')
for endpoint in endpoint_data_list:
    # print(endpoint['endpoint'])
    add_endpoint(VendorDataREST, endpoint)
