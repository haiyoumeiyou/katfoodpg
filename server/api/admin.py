...
endpoint_data_list = EndpointDataReader.getEndpointData('admin.json', '::')
for endpoint in endpoint_data_list:
    # print(endpoint['endpoint'])
    add_endpoint(AdminDataREST, endpoint)
