...
from server.model.track import TrackModel

EndpointDataReader = AppDataReader()
db = TrackModel()

class TrackDataREST(object):
    pass
...
endpoint_data_list = EndpointDataReader.getEndpointData('track.json', '::')
for endpoint in endpoint_data_list:
    # print(endpoint['endpoint'])
    add_endpoint(TrackDataREST, endpoint)
