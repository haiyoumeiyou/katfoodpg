...
from server.model.inventory import InvtModel

EndpointDataReader = AppDataReader()
db = InvtModel()

class InvtDataREST(object):
    pass
...
endpoint_data_list = EndpointDataReader.getEndpointData('invt.json', '::')
for endpoint in endpoint_data_list:
    # print(endpoint['endpoint'])
    add_endpoint(InvtDataREST, endpoint)
