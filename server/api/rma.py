...
from server.model.rma import RmaModel

EndpointDataReader = AppDataReader()
db = RmaModel()

class RmaDataREST(object):
    pass
...
endpoint_data_list = EndpointDataReader.getEndpointData('rma.json', '::')
for endpoint in endpoint_data_list:
    # print(endpoint['endpoint'])
    add_endpoint(RmaDataREST, endpoint)
