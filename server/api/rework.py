...
from server.model.rework import ReworkModel

EndpointDataReader = AppDataReader()
db = ReworkModel()

class ReworkDataREST(object):
    pass
...
endpoint_data_list = EndpointDataReader.getEndpointData('rework.json', '::')
for endpoint in endpoint_data_list:
    # print(endpoint['endpoint'])
    add_endpoint(ReworkDataREST, endpoint)
