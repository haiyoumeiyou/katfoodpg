...
from server.model.misc import MiscModel

EndpointDataReader = AppDataReader()
db = MiscModel()

class MiscDataREST(object):
    pass
...
endpoint_data_list = EndpointDataReader.getEndpointData('misc.json', '::')
for endpoint in endpoint_data_list:
    # print(endpoint['endpoint'])
    add_endpoint(MiscDataREST, endpoint)
