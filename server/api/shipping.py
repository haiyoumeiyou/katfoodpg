...
from server.model.shipping import ShipModel

EndpointDataReader = AppDataReader()
db = ShipModel()

class ShipDataREST(object):
    pass
...
endpoint_data_list = EndpointDataReader.getEndpointData('ship.json', '::')
for endpoint in endpoint_data_list:
    # print(endpoint['endpoint'])
    add_endpoint(ShipDataREST, endpoint)
