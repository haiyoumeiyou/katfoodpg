...
class FileModel(object):
    ...
    def insert(self, queries, query_params, headers=None):
        # print(queries, query_params)
        return db.insert(queries, query_params)
    ...
    def generate_pdf(self, query, query_params, pdf_generator):
        data = db.read(query, query_params)
        # print(pdf_generator, data)
        # return getattr(pdf, pdf_generator)(data[1][0], 2)
        return getattr(pdf, pdf_generator)(data[1], 2)
