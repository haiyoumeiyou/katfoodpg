...
class DataMigrate(DataModel):
    ...
    def post_migrate(self):
        ...
        msg.append(self.db.execute_query(
            ...
            ALTER COLUMN eid ADD GENERATED BY DEFAULT AS IDENTITY;

            SELECT setval(pg_get_serial_sequence('data_codes', 'eid'), (SELECT MAX(eid) FROM data_codes) + 1);
            """
        ))
        msg.append(self.db.execute_query(
            """
            ...
            SELECT setval(pg_get_serial_sequence('users', 'eid'), (SELECT MAX(eid) FROM users) + 1);
            """
        ))
        msg.append(self.db.execute_query(
            """
            ...
            SELECT setval(pg_get_serial_sequence('roles', 'eid'), (SELECT MAX(eid) FROM roles) + 1);
            """
        ))
        msg.append(self.db.execute_query(
            """
            ...
            SELECT setval(pg_get_serial_sequence('accounts', 'eid'), (SELECT MAX(eid) FROM accounts) + 1);
            """
        ))
        msg.append(self.db.execute_query(
            """
            ...
            SELECT setval(pg_get_serial_sequence('items', 'eid'), (SELECT MAX(eid) FROM items) + 1);
            """
        ))
        msg.append(self.db.execute_query(
            """
            ...
            SELECT setval(pg_get_serial_sequence('transactions', 'eid'), (SELECT MAX(eid) FROM transactions) + 1);
            """
        ))
        msg.append(self.db.execute_query(
            """
            ...
            SELECT setval(pg_get_serial_sequence('trans_journal', 'eid'), (SELECT MAX(eid) FROM trans_journal) + 1);
            """
        ))
        msg.append(self.db.execute_query(
            """
            ...
            SELECT setval(pg_get_serial_sequence('orders', 'eid'), (SELECT MAX(eid) FROM orders) + 1);
            """
        ))
        msg.append(self.db.execute_query(
            """
            ...
            SELECT setval(pg_get_serial_sequence('order_lines', 'eid'), (SELECT MAX(eid) FROM order_lines) + 1);
            """
        ))
        msg.append(self.db.execute_query(
            """
            ...
            SELECT setval(pg_get_serial_sequence('shipments', 'eid'), (SELECT MAX(eid) FROM shipments) + 1);
            """
        ))
        msg.append(self.db.execute_query(
            """
            ...
            SELECT setval(pg_get_serial_sequence('assembly', 'eid'), (SELECT MAX(eid) FROM assembly) + 1);
            """
        ))
        msg.append(self.db.execute_query(
            """
            ...
            SELECT setval(pg_get_serial_sequence('model', 'eid'), (SELECT MAX(eid) FROM model) + 1);
            """
        ))
        msg.append(self.db.execute_query(
            """
            ...
            SELECT setval(pg_get_serial_sequence('assm_config', 'eid'), (SELECT MAX(eid) FROM assm_config) + 1);
            """
        ))
        msg.append(self.db.execute_query(
            """
            ...
            SELECT setval(pg_get_serial_sequence('assm_serial', 'eid'), (SELECT MAX(eid) FROM assm_serial) + 1);
            """
        ))
        msg.append(self.db.execute_query(
            """
            ...
            SELECT setval(pg_get_serial_sequence('assm_part_serial', 'eid'), (SELECT MAX(eid) FROM assm_part_serial) + 1);
            """
        ))
        msg.append(self.db.execute_query(
            """
            ...
            SELECT setval(pg_get_serial_sequence('assm_part_change_log', 'eid'), (SELECT MAX(eid) FROM assm_part_change_log) + 1);
            """
        ))
        msg.append(self.db.execute_query(
            """
            ALTER TABLE file_store_dir
            ALTER COLUMN eid ADD GENERATED BY DEFAULT AS IDENTITY;

            SELECT setval(pg_get_serial_sequence('file_store_dir', 'eid'), (SELECT MAX(eid) FROM file_store_dir) + 1);
            """
        ))
