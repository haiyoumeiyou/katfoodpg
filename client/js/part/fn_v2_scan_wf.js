...
class Model {
    ...
    async getMeta() {
        ...
        // const endpoint_rst = await this.router.dataExchange(d_endpoint, q_param);
        // const endpoint_status = endpoint_rst[0] === 'ok' ? endpoint_rst[0] : endpoint_rst.join(', ');
        // if (endpoint_rst[0] === 'ok') {
        //     this.component_data = endpoint_rst[1];
        // }
        // return {"meta":this.component_meta, "status":endpoint_status};
    }
    ...
    async dataChange(event, modal, data) {
        const action_list = [...this.component_meta.list_template.events?this.component_meta.list_template.events:[], ...this.component_meta.action_template.fields?this.component_meta.action_template.fields:[]];
        ...
        // const endpoint = this.component_meta.action_template.fields_attr.f_data_endpoint;
        // const rst = await this.getComponentData(endpoint, data);
        // console.log(rst);
        // this._commit(rst.data, rst.status);
    }
}
